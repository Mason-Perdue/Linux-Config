...
\section{Foreward}
This is a test of \LaTeX. It can do math $E=mc^2$. This is the right hand Reimann Sum Equation: $\lim_{n\to\infty} \sum_{k=1}^{n}(a+\frac{b - a}{n}k)(\frac{b-a}{n})$

\[ \lim_{n\to\infty} \sum_{k=1}^{n} (a + \frac{b - a}{n} k) (\frac{b - a}{n}) \]
